...
public class ForestSpecial2 extends Room {

    public ForestSpecial2(int x, int y) {
        super(x, y);
    }
    ...
    public void enterRoom(Person x) {
        ...
        x.setxLoc(this.xLoc);
        x.setyLoc(this.yLoc);
        System.out.println("You found the wood! Type 'keep' to place it in your inventory.");
